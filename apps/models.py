...
class Produto(db.Model):
    ...
    #__Produto_FIELDS__
    produto = db.Column(db.Text, nullable=True)
...
class Classificacao(db.Model):
    ...
    classificacao = db.Column(db.Text, nullable=True)

    #__Classificacao_FIELDS__END

    def __init__(self, **kwargs):
        super(Classificacao, self).__init__(**kwargs)
...
class Unidade(db.Model):
    ...
    #__Unidade_FIELDS__
    sigla = db.Column(db.String(255),  nullable=True)
    escala = db.Column(db.Boolean, nullable=True)

    #__Unidade_FIELDS__END

    def __init__(self, **kwargs):
        super(Unidade, self).__init__(**kwargs)
